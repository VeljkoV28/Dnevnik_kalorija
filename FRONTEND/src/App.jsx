...
import Dnevnici_kalorijaPromjeni from "./pages/dnevnici_kalorija/Dnevnici_kalorijaPromjena"
    ...
    return (
      <>
        ...
        <Routes>
          ...
          <Route path={RoutesNames.DNEVNIK_KALORIJA_PROMJENI} element={<Dnevnici_kalorijaPromjeni />} />
        </Routes>
      </>
    )
  }
